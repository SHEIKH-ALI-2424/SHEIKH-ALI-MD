    ...
    if (m.mentionedJid.includes(botNumber)) {
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "𝐒𝚯𝚵𝚰𝐊𝚯 𝚫𝐋𝚰 〽️𝐃 🥀",
            body: config.DESCRIPTION || "© Pᴏᴡᴇʀᴇᴅ Bʏ 𝐒𝚯𝚵𝚰𝐊𝚯 𝚫𝐋𝚰 〽️𝐃",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://i.imghippo.com/files/YZK6549KW.jpg", // Static image URL
            sourceUrl: "https://wa.me/923143702270?text=*Hi+𒁂𓄂❥𝕚𝕥𝕩.𝑺𝑯𝑬𝑰𝑲𝑯+𝑨𝑳𝑰%20🔥༽༼+♡𒁂*"><br><button> Developer </button> <br></a> sʜᴇɪᴋʜ ᴀʟɪ</p>",
